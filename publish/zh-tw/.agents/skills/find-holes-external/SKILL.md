...
metadata:
  ...
  derived-from-sha256: "81ddfa5a6175046152d464e00950219b46cfc149ea7ecfff30408a77c2ed8e7d"
---
...
**先確認輸出目錄是乾淨的。** `tmp/spoke/<ticket-id>/` 不存在才往下走；已經存在就換一個
ticket-id，或問使用者要不要清掉，**不要直接跑上去**。
