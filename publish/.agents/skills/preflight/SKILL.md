---
name: preflight
description: 開工前檢查這個專案的環境有沒有把工作流程靜默停用：流程規範那一章的內容讀不讀得到、skill 與 lens 齊不齊、tmp/ 有沒有被 gitignore、hub-dispatch 跑不跑得起來。只讀、只報告，不改任何設定。
metadata:
  derived-from: ".claude/skills/preflight/SKILL.md"
  derived-from-sha256: "63365338893b5a6709e3cfd7b5bdffd7ad0307265aa785178202e175e621af3b"
---
